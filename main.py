...
def TriangularArbitrage(symbol,exchange="upbit"):
    one_way,profit,KRW_CODE,BTC_CODE,KRW_BTC = checkTriangular(symbol,exchange)
    if profit > 1:
        if one_way == True:
            print("OneWay") 
            OneWay(symbol,KRW_CODE,BTC_CODE,KRW_BTC)

        elif one_way == False:
            print("AnotherWay")
            OtherWay(symbol,KRW_CODE,BTC_CODE,KRW_BTC)
...
for crypto in cryptos:
    ...
    try:
        ...
        print("Unable to compute arbitrage")
    print()
